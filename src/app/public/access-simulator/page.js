    ...
    return (
        <section className='bg-[#f9f9f9] pb-5'>
            ...
            <div className=' flex flex-col md:flex-row justify-center items-center'>
                <div>
                    <h1 className='text-[16px] font-bold text-[#000000] text-center md:text-left'>Login as a child into access sec</h1>
                    <input
                        type="text"
                        value={email}
                ...
                <div>
                <img src="/images/choose-avatar/girl_11.png" alt="Farrukh" className=" pl-5 " />
                </div>
               
            </div>
            <button className="primary-btn mt-5 bg-[#FE8840] text-white px-[60px] py-3 rounded-[25px] cursor-pointer transition">
                    Login
                </button>
            </div>
