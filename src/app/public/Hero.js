      ...
      '>
        ...
        {activeSection === "products" ? (
          <div className='md:w-[70%] flex items-center'>
            <h1 className="font-bold text-[50px] items-center">Payment Details</h1>

          </div>
        ) : (
          <div className='md:w-[70%] '>
            <h1 className="font-bold text-[50px]">Knowledge Connection Open the Door to the Future</h1>
            <p className="font-normal text-[26px]">Giving every student the opportunity to access the best education.</p>
