  ...
  return (
    <section className='flex flex-col items-center bg-[#398EBB]'>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center m-auto gap-5 py-5'>
        <div className='max-w-[90%] md:w-[400px] md:p-[26px] md:h-[658px] lg:h-[480px] bg-white rounded-xl  text-center border border-[#FE8840] flex flex-col items-center'>
          <img
        ...
        <div className='max-w-[90%] md:w-[400px] md:p-[26px] md:h-[658px] lg:h-[480px] bg-white rounded-xl px-5 text-center border border-[#FE8840] flex flex-col items-center'>
        <img
          className='w-[400px] h-[170px] p-0'
            src="/images/cost.png"
            alt="Acces"
