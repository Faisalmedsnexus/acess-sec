    ...
    return (
        <section className='flex flex-col items-center mt-[50px]'>
            <div className='flex flex-col justify-center'>
                <h1 className='font-poppins text-[25px] md:text-[40px] font-bold text-center py-5'>Our Promotional Videos</h1>
                <p className='text-[16px] md:text-[20px] font-quicksand font-normal text-[#62605b] text-center md:w-[45%] m-auto'>Online classes with teachers, continuous questions and answers during class if you do not understand. At the end of the session, the lesson is recorded for your child to review</p>
            ...
            <div className='flex flex-col sm:flex-row gap-5 py-3 mb-[50px]'>
                <div className='flex flex-row items-center shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-3 rounded-3xl'>
                    <img
                        ...
                        alt="Acces"
                    />
                    <h1 className='text-[22px] font-bold text-center items-center flex pr-[50px] font-poppins '>Live Classes</h1>
                </div>
                <div className='flex flex-row shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-3 rounded-3xl'>
                    <img
                        ...
                        alt="Acces"
                    />
                    <h1 className='text-[22px] font-bold text-center items-center flex pr-[50px] font-poppins '>Recorded Class</h1>
                </div>
                <div className='flex flex-row items-center shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-3 rounded-3xl'>
                    <img
                        ...
                        alt="Acces"
                    />
                    <h1 className='text-[22px] font-bold text-center items-center flex pr-[50px] font-poppins '>Audio Classes</h1>
                </div>
